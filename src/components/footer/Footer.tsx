...
export const Footer = () => {
  return (
    <div className="w-full h-full">
      <div className="w-full h-full flex justify-between gap-y-8 md:gap-y-0 items-start gap-x-3 flex-wrap  relative z-10 ">
        <div className="absolute left-0 top-0 w-full h-full pointer-events-none bg-gradient-to-b from-[#000] to-[#1E112A] -z-[1]"></div>
        <div className="w-full h-full flex justify-between gap-y-8 md:gap-y-0 items-start gap-x-3 flex-wrap px-8 md:px-16 relative z-10 py-4 pt-28 max-w-[1355px] mx-auto">
          <div>
