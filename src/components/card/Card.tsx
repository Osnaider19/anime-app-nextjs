...
export const Card = ({ id, imagen, title, genres, color }: Props) => {
  return (
    <div className="w-[230px] h-[280px] relative border border-[#ffffff20] overflow-hidden rounded-lg shadow-2xl shadow-[#ffffff10]">
      <img
        src={imagen}
        alt={`imagen de ${title}`}
      ...
      <div
        ...
        style={{
          background: `linear-gradient(${
            color + `90`
          }, transparent , transparent , transparent  , rgba(0,0,0,.7) , rgba(0,0,0,.7)  , rgba(0,0,0,.7)  , rgba(0,0,0,.7))`,
        }}
      ></div>
